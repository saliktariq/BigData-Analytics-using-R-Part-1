...
```{r}
predict(lm.fit, data.frame(horsepower = c(89)), interval = "confidence", conf.level=0.99)
```
The upper 99% confidence interval is 26.41279
The lower 99% confidence interval is 25.36257
```{r}
predict(lm.fit, data.frame(horsepower = c(89)), interval = "prediction", pred.level=0.99)
```
