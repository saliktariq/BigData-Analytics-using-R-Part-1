...
P(Temperature = Hot | Play Golf = Yes) = 5/12 = 0.4166
P(Temperature = Hot | Play Golf = No) = 7/12 = 0.5834
P(Temperature = Cool | Play Golf = Yes) = 5/8 = 0.625
P(Temperature = Cool | Play Golf = No) = 3/8 = 0.375

P(Play Golf = Yes | Temperature = Hot) = (0.4166 * 0.5)/0.6 = 0.347
P(Play Golf = No | Temperature = Hot) = (0.5834 * 0.5)/0.6 = 0.486
P(Play Golf = Yes | Temperature = Cool) = (0.625 * 0.5)/0.4 = 0.78125
P(Play Golf = No | Temperature = Cool) = (0.375 * 0.5)/0.4 = 0.46875
